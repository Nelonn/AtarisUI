...
{
    /// <summary>
    /// Interaction logic for RAMUsageText.xaml
    /// </summary>
    public partial class RAMUsageText : UserControl, IWidget
    {
        private Timer timer;
        ...
        public RAMUsageText(dynamic settings)
        {
            ...
            this.timer.Elapsed += delegate {
                ...
                {
                    this.textBlock.Text = $"RAM: {Math.Round((1 - (data.PhysicalAvailableBytes / (double)data.PhysicalTotalBytes)) * 100)}%";
                }));
            };
            this.timer.Start();
        }
